...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContentPlaceholder" runat="server">
    ...
    <p>
        <br />
        <asp:Table ID="tblError" Visible="false" runat="server">
            <asp:TableRow>
                <asp:TableCell>
                    <asp:Image ImageUrl="~/Resources/images/cute_goat.jpg" height="200" width="250" runat="server"/>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell >
                    <asp:Label runat="server" Text="We're sorry. Something went wrong with your request. Please try again." />
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
    </p>
